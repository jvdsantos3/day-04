...
- **Phase / Task**: Phase 2 (Auth) COMPLETA — T8 (auth dependency + isolation) done; próxima Onda 9 (paralelo): T9 (TransactionRepository) ∥ T12 (chroma client) ∥ T13 (embeddings)
- **Completed**: Specify, Design, Tasks, T1–T8
- **In-progress**: none
- **Next step**: Iniciar Onda 9 — T9/T12/T13 podem rodar em paralelo (dependem só de T8). T9 é o próximo natural para desbloquear T10/T14/T16/T17.
- **Blockers**: none
- **Uncommitted files**: none (feat T8 commitado; falta commit chore de status)
